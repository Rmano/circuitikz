...
{%
    \par\medskip\noindent
    \if\ctikz@ex@pos t
        \begin{BlockClass}{fullwidth-block}
...
%%% Force the style to have xleftmargin=0, otherwise there is a spurious space
%%% at the start of every listing in HTML. Not sure why.
